...
#include "Marlin.h"
  ...
  #include "util/vector_3.h"
  #if ENABLED(AUTO_BED_LEVELING_GRID)
    #include "util/qr_solve.h"
  #endif
...
#include "core/endstops.h"
#include "core/temperature.h"
#include "sd/cardreader.h"
#include "module/configuration_store.h"
#include "core/language.h"
#include "module/nozzle.h"
...
#include "math.h"
  ...
  #include "module/stepper_dac.h"
#endif

#if ENABLED(EXPERIMENTAL_I2CBUS)
  #include "module/twibus.h"
#endif
...
static void report_current_position() {
  ...
  #include "gcode/control/M380.h"     // Enable solenoid on the active extruder
  #include "gcode/control/M381.h"     // Disable all solenoids
